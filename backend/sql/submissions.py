...
def select_submissions(conn, course_id: str, assignment_id: int) -> list[SubmissionDTO]:
    """
    Returns the list of all submissions to the given assignment, from most recent to most early
    """
    with conn.cursor() as db_cursor:
        db_cursor.execute(
            """
